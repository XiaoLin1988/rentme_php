            ...
            <aside class="main-sidebar">
                ...
                <?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?=active_link_controller('projects')?>">
                            <a href="<?php echo site_url('admin/projects'); ?>">
                                <i class="fa fa-tasks"></i> <span><?php echo lang('menu_projects'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('skills')?>">
                            <a href="<?php echo site_url('admin/skills'); ?>">
                                <i class="fa fa-asterisk"></i> <span><?php echo lang('menu_skills'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('services')?>">
                            <a href="<?php echo site_url('admin/services'); ?>">
                                <i class="fa fa-viadeo"></i> <span><?php echo lang('menu_services'); ?></span>
                            </a>
                        </li>
